...
Except for very simple models, parameters cannot be easily interpreted as quantities of interest. Instead, we can use packages like `ggeffects`, `marginaleffects`, `emmeans`, or `modelbased` to compute and plot predictions, estimate quantities of interest, and perform tests.
