...
In addition to `supernova()`, here I use `modelsummary()` and `compare_performance()` functions from the [`modelsummary`](https://modelsummary.com/) and [`performance`](https://easystats.github.io/performance/) packages to evaluate and compare models.
