...
In addition to `supernova`, here I use the `modelsummary()` and the `compare_performance()` functions from the [`modelsummary`](https://modelsummary.com/) and [`performance`](https://easystats.github.io/performance/) packages to evaluate and compare models, respectively.
