...
```{r}
predict_response(m, terms = c('wt', 'am')) %>% plot()
```
...
```{r}
##test_predictions(m, contrast = 'am', by = c('wt = [2.5, 3, 3.5]'))
```
...
```{r}
##estimate_contrasts(m, contrast = 'am', by = c('wt = [2.5, 3, 3.5]')) %>% plot()
```

```{r}
##test_predictions(m, contrast = 'am', by = c('wt = [2.5, 3, 3.5]')) %>% plot()
```
