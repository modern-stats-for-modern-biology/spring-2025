...
-   **Probability theory** is the completion of **propositional logic**
    ...
    -   A mathematical language we use to **represent** our **knowledge** of the world **and** to **reason with it** (from premises known or assumed to be true to a conclusion that is likely to be true/uncertain; *inductive reasoning*)
...
-   The main goal of **Bayesian inference** is to estimate the **posterior probability distribution** $\; P(H \mid E)$

-   The main goal of **frequentist inference** is to control the **false positive rate** $\; P(E \mid \lnot H)$ at $\alpha = 0.05$
