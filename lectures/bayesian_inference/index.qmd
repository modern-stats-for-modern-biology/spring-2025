...
-   The main goal of **frequentist inference** is to control the **false positive rate** $\; P(E \mid \lnot H)$

-   The main goal of **Bayesian inference** is to estimate the **posterior probability distribution** $\; P(H \mid E)$

## Most published research findings are false!

[![](images/why-most-published-research-findings-are-false.png){fig-align="center"}](https://doi.org/10.1371/journal.pmed.1004085)
