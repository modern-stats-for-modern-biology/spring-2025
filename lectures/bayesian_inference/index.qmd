...
::: nonincremental
-   Another way of thinking about a random variable is simply as a variable (data object) in R that can take different values of different types: `Logical`, `Numeric`, `Factor`, etc.
:::
