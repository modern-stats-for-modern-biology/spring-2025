...
-   **Frequentist inference** emphasizes controlling the **false positive rate** $\; P(E \mid \lnot H)$

-   **Bayesian inference** emphasizes estimating the **posterior probability distribution** $\; P(H \mid E)$
