...
-   Probability theory is a very simple language
    ...
    -   The 5 functions/operators/rules of propositional logic:
...
::: fragment
$$
P(D \mid T) = \frac{P(D) \cdot P(T \mid D)}{P(T)}
$$
:::
...
![](images/Akshay.bayes_theorem_the_formula.jpg){fig-align="center" width="703"}
...
![](images/Akshay.visual_proof_bayes'_theorem.jpg){fig-align="center" width="617"}
...
-   Given (known quantities/premises/evidence/knowledge base):
    ...
    -   $P(D) = 0.001 \;$ **prior**/prevalence

    -   $P(T \mid D) = 0.90 \;$ **likelihood**/sensitivity
    
    -   $P(\lnot T \mid \lnot D) = 0.90 \;$ specificity
    
    -   $P(T \mid \lnot D) = 0.10 \;$ false positive rate = (1 - specificity)

    -   $P(\lnot D) = 0.999\;$ (1 - prevalence)
...
-   **Frequentist inference** emphasizes controlling the **false positive rate** $\; P(T \mid \lnot D)$

-   **Bayesian inference** emphasizes estimating the **posterior probability distribution** $\; P(D \mid T)$
