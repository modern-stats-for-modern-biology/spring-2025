...
:::: fragment
::: text-align-center
![](images/Slide139.png){fig-align="center" width="711"}
:::
::::
...
-   Another way of thinking about a random variable is simply as a variable (data object) in R that can take on different values of different types: `Logical`, `Numeric`, `Factor`, etc.
...
-   This is analogous to our earlier, simpler example with only logical variables `A` and `B`, and the same principles and operations apply (including the calculation of probabilities and application of probability distributions) regardless of whether the random variables are logical, numeric, or categorical
