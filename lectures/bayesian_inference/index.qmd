...
-   If one of the [standard probability distributions](https://distribution-explorer.github.io/) (e.g., uniform, binomial, normal) is a useful abstraction of the real process you need to model, then it can be used as the statistical model for your inferential data analysis (if not, you can always [build your own](https://prob.bayesfusion.com/))

-   Standard probability distributions serve as ready-made "*data stories*", i.e., sets of assumptions about the DGP
