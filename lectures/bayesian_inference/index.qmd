...
-   A probability distribution is a function $p$ that assigns a probability (mass) to each possible world/outcome $\omega$
:::
...
::: nonincremental
-   $p$ encodes our premises/assumptions/evidence/knowledge base: each assigned probability reflects what we know (or assume) about each possible world/outcome $\omega$
:::
...
-   Rather than enumerating each probability or specifying every premise/assumption, these probability distributions provide compact representations of the evidence/knowledge base underlying common scenarios
...
-   Alternatively, think of a random variable as a **question** about each possible world, where the **answer is a number**
