...
-   **Ontological interpretations** (probability as a feature of reality; *objective*)
    ...
    -   **Limiting relative frequency**: [Probability as a feature of an infinite sequence of trials]{.blue}

    -   **Physical chance/propensity**: [Probability as a feature of a physical system]{.blue}

-   **Epistemological interpretations** (probability as a measure of uncertainty; *subjective*)

    -   **Rational degree of belief**: [Probability as a feature of a proposition]{.blue}

    -   **Rational degree of evidential support**: [Probability as a feature of an argument]{.blue}
:::
...
-   **Disjunction rule (OR)**: Sum rule
    ...
    -   Iff A and B are disjoint, i.e., $P(A \land B) = 0$:
...
$$
P(H \mid E) = \frac{P(H) \cdot P(E \mid H)}{\int_{i=1}^\infty P(H_i) \cdot P(E \mid H_i)}
$$
...
-   This integral is often intractable, making analytical solutions difficult or impossible; that's why Bayesian inference remained limited to simple cases until modern computing enabled efficient approximations using [Markov Chain Monte Carlo](https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo) (MCMC) methods
