...
-   **Ontological interpretations** (probability as a feature of reality; *objective*)
...
-   **Epistemological interpretations** (probability as a measure of uncertainty; *subjective*)
    ...
    -   **Rational degree of evidential support/strength of an inductive argument** (objective Bayesian): The proportion of possible worlds where both the hypothesis and the evidence are true, relative to the possible worlds where the evidence is true

-   In this series of lectures, we focus on the **objective Bayesian** interpretation of probability, because it incorporates all the others–except when probability measures true randomness ([quantum randomness](https://quantumphysicslady.org/glossary/quantum-randomness/))
...
-   **Ontological interpretations** (probability as a feature of reality; *objective*)
    ...
    -   **Limiting relative frequency**: [Probability as a feature of an infinite sequence of trials]{.orange}

    -   **Physical chance/propensity**: [Probability as a feature of a physical system]{.orange}

-   **Epistemological interpretations** (probability as a measure of uncertainty; *subjective*)

    -   **Rational degree of belief**: [Probability as a feature of a proposition]{.orange}

    -   **Rational degree of evidential support**: [Probability as a feature of an argument]{.orange}
:::
...
-   The numerator is the joint probability of hypothesis $H$ and evidence $E$
    ...
    -   $P(E \mid H)$ is the likelihood of evidence $E$ given hypothesis $H$ (a.k.a. the **likelihood**)
:::
...
Don't fall to the sin of reification!
...
-   Given a sample space/universe $\Omega$
...
-   A probability distribution is a function $p$ that assigns a probability to each possible outcome/world $\omega$
:::
...
::: fragment
For example, if proposition $X$ is $A \lor B$, then $P(X) = P(A \lor B)$ is calculated as
:::
...
$$\forall \omega_i \in \Omega \quad p(\omega_i) = \frac{1}{|\Omega|}$$

::: nonincremental
where $p(\omega_i)$ is the probability (or more precisely the *probability mass*) of $\omega_i$

-   $p$ is also known as **probability distribution** or *probability mass function* (PMF) of $\Omega$

-   For example, given the following sample space $\quad p(\omega_i) = \frac{1}{4} = 0.25$
:::
