...
-   **Probability theory** is a mathematical language that we use to:
    ...
    -   **reason** about the plausibility of propositions, given the knowledge base, i.e.,
...
-   This integral is often very difficult to compute, and that's why Bayesian inference was relegated to simple cases until the advent of modern computers and [Markov Chain Monte Carlo](https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo) (MCMC) methods
