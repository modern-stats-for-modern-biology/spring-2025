...
-   Standard probability distributions (e.g., uniform, binomial, normal) encode different assumptions about the DGP; if one is a useful abstraction of the real process, then it is chosen to be the statistical model
...
-   $p$ encodes our premises/assumptions/evidence/knowledge about the world in general

-   In the context of statistical inference, $p$ is the statistical model that encodes our knowledge about the DGP
...
-   Several other mathematical functions (e.g., the binomial and normal distributions) have been developed to capture different sets of premises/assumptions about the DGP of standard "*data stories*"
