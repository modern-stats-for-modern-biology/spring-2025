...
##  Sometime correlation is causation!

-   When there are no confounders and there is a linear relationship between the treatment and the outcome, then correlation is causation

-   Adjusting for baseline covariates can make an estimate more precise

## Causal inference workflow

1.  **Specify causal question** (e.g., estimand of randomized control trial)

2.  **Make causal model** (e.g., draw causal diagram)

3.  **Test causal model**

4.  **Translate DAG into statistical model** (e.g., multivariate linear regression)

5.  **Test statistical model**

6.  **Estimate causal effect using statistical model** (e.g., regression coefficient)
...
These three variables are a minimal adjustment set, the minimum set of variables to adjust for in order to block all backdoor paths/confounding effects between treatment and outcome
...
##  {background-image="causal_salad/part.02.slide.07.png" background-size="50%"}
...
-   In a graphical causal model (a.k.a. a causal diagram or DAG), this function is represented by an arrow that connects two variables
...
##  {background-image="causal_salad/part.02.slide.08.png" background-size="50%"}

## Make a causal model

-   A DAG only says which variables influence which

-   It does not say how variables influence one another
...
##  {background-image="causal_salad/part.02.slide.30.png" background-size="50%"}

## Analyze a causal model

-   Causal model can be complicated
...
-   All of this requires understanding **d-separation** 




##  {background-image="causal_salad/part.02.slide.31.png" background-size="50%"}
...
##  {background-image="causal_salad/part.02.slide.39.png" background-size="50%"}
...
##  {background-image="causal_salad/part.02.slide.61.png" background-size="50%"}

##  {background-image="causal_salad/part.02.slide.62.png" background-size="50%"}

##  {background-image="causal_salad/part.02.slide.63.png" background-size="50%"}
...
4.  Write causal relationships as arrows (directed edges)
...
-   A backdoor path is a path between a treatment and an outcome that contains an arrow into the treatment node

-   In experimental studies like a randomized controlled trial, randomized treatment allocation blocks all backdoor paths

-   In observational studies, we need to block all backdoor paths to estimate the causal effect of the treatment on the outcome

-   Stratification, adjustment, weighting, matching, etc. can be used to block backdoor paths
