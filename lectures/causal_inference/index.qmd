...
Use linear regression to adjust for variables in adjustment set in order to estimate the causal effect of bed net use on malaria risk free of confounding effects (assuming statistical and causal models are good approximation of reality)
...
See also: [thinkCausal](https://thinkcausal.org/)
