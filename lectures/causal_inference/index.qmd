...
-   **Statistical inference**: learning [**statistical relationships**]{.orange} (patterns of association) between random variables

    -   Predict **unobserved outcomes** under [**same**]{.red} conditions (without doing anything)\
        [*What if I see this?*]{.gray}

-   **Causal inference**: learning [**cause-and-effect relationships**]{.orange} between random variables

    -   Predict **unobserved outcomes** under [**changed**]{.red} conditions (after doing/if had done something):
