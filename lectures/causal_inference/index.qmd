...
## Causal inference: science before statistics

- Causal inference requires:

  - A **causal model** distinct from the statistical model

  - Analysis of the implications of the causal model for (1) research design, (2) testing, (3) estimation strategy

  - Some way to perform estimation

- Descriptive and experimental research are no exception
