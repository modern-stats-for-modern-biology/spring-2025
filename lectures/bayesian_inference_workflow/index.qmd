...
A convenient way to represent the **premises** of **inductive arguments** about different DGPs
...
$$
p(\omega \mid K_{\text{GLM}}) = \frac{1}{\sqrt{2\pi \sigma^2}} \exp \!\left( -\frac{\bigl(y - \mu \bigr)^2}{2\sigma^2} \right)
$$ $$
...
$$
p(\omega) = \frac{1}{\sqrt{2\pi \sigma^2}} \exp \!\left( -\frac{\bigl(y - (\beta_0 + \beta_1 \cdot x) \bigr)^2}{2\sigma^2} \right)
$$
:::
:::::
...
$$
p(x, y \mid \beta_0, \beta_1, \sigma, E_{\text{GLM}}) = \frac{1}{\sqrt{2\pi \sigma^2}} \exp \!\left( -\frac{\bigl(y - (\beta_0 + \beta_1 \cdot x) \bigr)^2}{2\sigma^2} \right)
$$
:::
:::::
