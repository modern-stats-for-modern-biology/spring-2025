...
::: nonincremental
-   Use the `suppressPackageStartupMessages` function to suppress messages that are generated when loading a package
:::
...
-   The global environment (`.GlobalEnv`) is always searched first, followed by package environments in the order they were loaded, with the `base` package environment always appearing last
