...
[Goodman (2019)](https://www.tandfonline.com/doi/full/10.1080/00031305.2018.1558111)
:::
:::::
...
More than 200 biologists analysed the same data — and got widely divergent results!
...
-   Week 1: Motivation for and intro to the course and Jupyter notebooks
...
::: fragment
Each week, before the start of the first class of the week (Monday at 12:30pm, with a few exceptions), you will be expected to:
...
::: fragment
Each week, before the start of the second class of the week (Tuesday at 12:30pm, with a few exceptions), you will be expected to:
...
::: fragment
The primary grading criterion (50%) will be completion of the assignments and submission of code that works. Correctness is a secondary grading criterion (10%).
:::
...
In the **Assignments** section of the course on [Blackboard](https://learn.mssm.edu/); **DUE BY EOD TODAY!**
