...
8.  Check model assumptions and test model using training data (posterior predictive check)
9.  Test model using new data (replication)
10. Profit but keep testing (severely)
...
### Check model assumptions and test model using training data
