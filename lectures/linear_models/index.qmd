...
-   Simulated data (predictions) can also be generated from this model by specifying the parameters $\beta_0$, $\beta_1$, and $\sigma$
...
df %>%
  ...
  gf_point(H ~ W, data = df %>% group_by(H) %>% sample_n(3), color = "skyblue4") %>% 
