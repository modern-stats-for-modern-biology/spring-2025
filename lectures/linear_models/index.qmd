...
7.  **Evaluate** the fitted model assumptions and predictions with the training data (e.g., cross-validation, residual analysis, posterior predictive checks), [given estimate, estimator, model, data, estimand, question]{style="color: orangered"}
...
## Compare the Bayesian and frequentist estimates {.scrollable}
...
## Evaluate fitted model assumptions
...
#| fig-height: 5
#| output-location: default
performance::check_model(mle.lm.fit, check = "normality")
```

## Evaluate fitted model assumptions

$$y_i = \beta_0 + \beta_1 \cdot x_i + \epsilon_i \quad \quad \epsilon_i \stackrel{\text{i.i.d.}} \sim \text{Norm}(0, \sigma)$$
**Homoscedasticity (homogeneity of variance) of errors**
...
## Evaluate fitted model predictions
