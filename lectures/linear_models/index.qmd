...
-   The problem of statistical inference
    ...
    -   [It's impossible to calculate the inverse probability!]{.underline}
...
::: notes
Bayesian inference in a nutshell: A method for figuring out unobservable quantities/unknown facts given observable quantitities/know facts that uses probability to describe the uncertainty over the values of the unknown quantities
...
Clearly state the *research question*, based on prior knowledge and domain expertise

![](images/Slide1.png)

## Identify the estimand

From a *research question* to a *quantity of interest*: the **estimand**
...
Build a probability *model* of the DGP [to capture important features of the *estimand* and *sampling process*]{.fragment}

![](images/Slide6.png)

## Fit the statistical model to the data

Condition the probability *model* of the DGP on the *data* using an **estimator** to obtain an **estimate** of the *estimand*
