...
::: fragment
$p(x, y \mid M_1) = p(x, y \mid \beta_0 = 3, \beta_1 = 1, M_L)$
:::

::: fragment
$\quad \quad M_L: y = \beta_0 + \beta_1 \cdot x$
:::
...
::: fragment
$p(x, y \mid M_2) = p(x, y \mid \beta_0 = 3, \beta_1 = 1, \sigma = 1, M_{L+E_\text{Unif}})$
:::

::: fragment
$\quad \quad M_{L+E_\text{Unif}}: y = \beta_0 + \beta_1 \cdot x + \epsilon \quad \quad \epsilon \in [-\sigma, \sigma]$
:::
...
::: fragment
$\quad \quad M_{L+E_\text{Unif}}: y = \beta_0 + \beta_1 \cdot x + \epsilon \quad \quad \epsilon \sim \text{Unif}(\mu = 0, \sigma)$
:::

::: fragment
$\quad \quad M_{L+E_\text{Unif}}: y \sim \text{Unif} (\mu = (\beta_0 + \beta_1 \cdot x), \sigma)$
:::

::: fragment
$p(x, y \mid M_2) = p(x, y \mid \mu = (3 + 1 \cdot x), \sigma = 1, M_{\text{Unif}})$
:::
...
::: fragment
$p(x, y \mid M_3) = p(x, y \mid \beta_0 = 3, \beta_1 = 1, \sigma = 1, M_{L+E_\text{Norm}})$
:::

::: fragment
$\quad \quad M_{L+E_\text{Norm}}: y = \beta_0 + \beta_1 \cdot x + \epsilon \quad \quad \epsilon \sim \text{Norm}(\mu = 0, \sigma)$
:::

::: fragment
$\quad \quad M_{L+E_\text{Norm}}: y \sim \text{Norm} (\mu = (\beta_0 + \beta_1 \cdot x), \sigma)$
:::

::: fragment
$p(x, y \mid M_3) = p(x, y \mid \mu = (3 + 1 \cdot x), \sigma = 1, M_{\text{Norm}})$
:::
...
$p(x, y \mid M_4) = p(x, y \mid \beta_0 = 3, \beta_1 = 1, \sigma = 1, M_{L+E_\text{Cauchy}})$

::: fragment
$\quad \quad M_{L+E_\text{Cauchy}}: y = \beta_0 + \beta_1 \cdot x + \epsilon \quad \quad \epsilon \sim \text{Cauchy}(\mu = 0, \sigma)$
:::

::: fragment
$\quad \quad M_{L+E_\text{Cauchy}}: y \sim \text{Cauchy} (\mu = (\beta_0 + \beta_1 \cdot x), \sigma)$
:::

::: fragment
$p(x, y \mid M_4) = p(x, y \mid \mu = (3 + 1 \cdot x), \sigma = 1, M_{\text{Cauchy}})$
:::
...
-   **Neyman–Pearson hypothesis testing**
    ...
    -   This approach requires specifying an alternative hypothesis $H_1$ and Type I/II error rates, and planning sample sizes for sufficient [statistical power](https://en.wikipedia.org/wiki/Power_of_a_test) (e.g., $1 - \beta = 0.80$)
