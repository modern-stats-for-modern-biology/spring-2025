...
“When there is no available evidence or rational basis to favor one possibility over another, all possibilities should be assigned equal probability. That is, if a set of disjoint and exhaustive outcomes are indistinguishable given the known information, they must be treated as equally probable.”
...
\begin{array}{l}
P(A \lor B) = P(A) + P(B) - P(A \land B) \\
P(A \lor B) = P(A) + P(B) \quad \text{iff A and B are disjoint/mutually exclusive, i.e.,}\ P(A \land B) = 0
\end{array}
$$
:::
