...
-   Bayes’ theorem is more than just a formula: It captures the *mathematical shape* of uncertainty, or more precisely, the *dynamics* of how uncertainty updates in response to new information
...
-   If $A$ and $B$ are **mutually exclusive** (i.e., $P(A \land B) = 0$) **and exhaustive** events (a.k.a. partitions), then the sum rule simplifies to:
...
-   **Mutually exclusive and exhaustive** events are **partitions** of the sample space
