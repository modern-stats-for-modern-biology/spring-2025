...
![](proportional_syllogism_on_steroids/Slide1.png){fig-align="center"}

## Proportional syllogism on steroids

![](proportional_syllogism_on_steroids/Slide2.png){fig-align="center"}
...
$$P(B \mid C) = \frac{4 + 2}{10} = \frac{6}{10} = 0.6$$
:::
...
-   Two events (or propositions) $A$ and $B$ are **mutually exclusive** iff they cannot occur simultaneously (or they cannot both be true)
