...
-   In particular, Bayes’ theorem is fundamental to the [free energy principle](https://en.wikipedia.org/wiki/Free_energy_principle), which conceptualizes the brain as a Bayesian engine that continuously updates its internal model of reality based on incoming sensory information
...
Events $A$ and $B$ are **dependent**, i.e., **statistically associated**!
:::
...
::: {.fragment .text-align-center}
Events $A$ and $B$ are **independent**, i.e., **NOT statistically associated**!
:::
...
-   **Mutually exclusive and exhaustive** events divide the sample space into **partitions**

-   Let $\{X_1, X_2, \ldots, X_n\}$ be a set of mutually exclusive and exhaustive events/partitions
...
-   **Outcomes are partitions of the sample space!**

## Probability theory: Law of total probability

::: nonincremental
-   $B$ and $\lnot B$ are mutually exclusive and exhaustive events, therefore:
:::
