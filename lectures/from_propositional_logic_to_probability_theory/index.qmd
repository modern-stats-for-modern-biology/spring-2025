...
-   If $A$ and $B$ are mutually exclusive events, then the sum rule simplifies to:
...
-   If $A$ and $B$ are **mutually exclusive** (i.e., $P(A \land B) = 0$) **and exhaustive** events, then the sum rule simplifies to:
