...
-   **Propositional logic** is a mathematical language that we use to:
    ...
    1.  **represent knowledge** with propositions, and
    2.  **reason** about the **truth** of propositions, given the knowledge base
...
- **Prevalence (prior probability):**  
  $P(D) = 0.001$ (i.e., a 0.1% chance of having breast cancer)
- **Sensitivity:**  
  $P(T \mid D) = 0.90$ (i.e., 90% chance the test is positive if the woman has breast cancer)
- **Specificity:**  
  $P(\lnot T \mid \lnot D) = 0.90$ (i.e., 90% chance the test is negative if the woman does not have breast cancer)
- **False Positive Rate:**  
  $P(T \mid \lnot D) = 1 - P(\lnot T \mid \lnot D) = 1 - 0.90 = 0.10$  
...
::: fragment
$$
P(D \mid T) = \frac{P(D) \cdot P(T \mid D)}{P(D) \cdot P(T \mid D) + P(\lnot D) \cdot P(T \mid \lnot D)}
$$
:::
