...
-   A proposition is a statement/declarative sentence that is either true or false
...
-   **Deductive reasoning**: If the premises are true and (according to the rules of *propositional logic*) the argument is **valid**, then the conclusion is true
...
-   **Inductive reasoning**: If the premises are true and (according to the rules of *probability theory*) the argument is **strong**, then the conclusion is probable
