...
-   It represents an assertion or claim about a particular state of affairs in the world
    ...
    -   "*unicorns poop candy*" 🦄🍭 [is a proposition]{.fragment .green}
...
-   Recall: The goal of **deductive reasoning** is to determine whether the conclusion is guaranteed to be true, assuming the premises are true

-   In other words, a logical argument is deductively valid iff the premises ($E$) logically entail the conclusion ($H$), i.e., in every possible world where $E$ is true, $H$ is also true

::: fragment
$$E \models H$$
:::

-   Therefore, we can formalize deductive reasoning using this function:
...
-   Next, we will implement the $V$ function in R to build a simple AI for deductive reasoning
...
-   We will determine the deductive validity of this logical argument in three steps:
