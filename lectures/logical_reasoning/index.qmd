...
-   The process of drawing a probable **conclusion** about a >>**MODEL**<< of the data generating process (DGP, a.k.a., a "*population*") based on model assumptions and incomplete **DATA** (a.k.a., a "*sample*") as **evidence**
