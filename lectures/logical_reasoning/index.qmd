...
| English | Math | R |
|:-----------------------------------------|:--------------|:--------------|
| $P$ "*the robot is **NOT** blue*" | $\lnot B$ | `!B` |
| $Q$ "*the robot is blue **AND** it has an antenna*" | $B \land A$ | `B & A` |
| $R$ "***IF** the robot has an antenna **THEN** it's **NOT** blue*" | $A \implies \lnot B$ | `A %=>% !B` |
:::
...
::: notes
-   $A \land \lnot A$ "*the robot has an antenna **AND** it does **NOT** have an antenna*" is an example of a **contradiction**: A proposition that is always false ($\bot$)
...
::: notes
-   $A \lor \lnot A$ "*the robot has an antenna **OR** it does **NOT** have an antenna*" is an example of a **tautology**: A proposition that is always true ($\top$)\]
