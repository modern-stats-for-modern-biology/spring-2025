...
Statistical inference is logical reasoning using 1) **data** (*measurements of observable quantities*) and 2) a **model** of the data generating process (DGP) to infer *unobservable quantities*:
