...
Statistical inference is logical reasoning using **data** (*measurements of observable quantities*) and a **model of the data generating process** (DGP) to infer *unobservable quantities*:
