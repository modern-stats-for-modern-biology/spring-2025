...
-   We will determine the deductive validity of this argument following these steps:

    1.  Build the truth table of this argument:
    ...
    3.  Check that in every row where $E$ is true, $H$ is also true
