...
-   **Compound propositions** are formed by combining propositions using **logical operators**
    ...
    -   "*Unicorns poop ice cream if and only if it's raining.*"
    
    -   "*It's raining and Unicorns poop ice cream!*"
...
-   A **logical variable** is a symbol representing a proposition

-   A logical variable holds a value (**truth value**) that is either **True** or **False**, but not both

-   Logical variables are also known as propositional or Boolean variables and are typically denoted by uppercase Roman letters
...
-   A **logical operator** (also called a logical connective or Boolean operator) is a symbol representing a function that combines one or more propositions (atomic or compound) to form a compound proposition
...
-   The truth value of an atomic proposition is assigned

-   The truth value of a compound proposition is determined by the logical operators and the truth values of its atomic components, according to the **rules of propositional logic**
