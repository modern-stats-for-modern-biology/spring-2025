...
## The challenge of modern biology

-   Biological processes are complex and their output variable

::: {.fragment style="text-align: center"}
[![](images/human_evolution.jpg){height="180"}](https://medium.com/@alasaarela/ai-has-taken-over-our-cultural-evolution-aec131bd4087)
:::

-   This output can be as simple as the expression level of a single gene in a piece of tissue or as complex as a biological organism
-   Biological data are therefore variable and can be extremely complex (e.g., multi-ome data from thousands of single cells in their spatial and temporal contexts)
-   The challenge of modern biology: **Learning about biological systems from variation in complex data**
-   Learning about the real world from variation in data is the main goal of statistics
-   Data viz and summary stats are used to explore and describe variation in data

## Data analysis pipeline/workflow

:::::: columns
::: {.column .fragment width="30%"}
![](images/FisherParadigm.png){height="500"}
:::

::: {.column .fragment width="30%"}
![](images/data_pipeline.webp){height="500"}

[Leek and Peng (2015)](https://doi.org/10.1038/520612a)
:::

::: {.column .fragment width="40%"}
![](images/iterativeparadigm.png){height="500"}

[Tukey (1977)](https://search.worldcat.org/title/Exploratory-data-analysis/oclc/3058187)

[Exploratory (EDA) vs confirmatory data analysis (CDA)]{style="font-size: 0.6em"}
:::
::::::
...
-   A valid name must start with a letter or a dot not followed by a number
...
VALID_NAME <- "foo" # all upper-case names are usually reserved for user-defined constants

valid.name <- TRUE

.valid_name <- NULL

`Valid name with spaces and special characters!` <- pi # `pi` is a built-in constant with value 3.142
```
:::
...
#| eval: false
#| output-location: default
?rm # for help on the `rm` function, same as `help(rm)`
```
:::
...
#| eval: false
#| output-location: default
??rm # to search help for the "rm" string, same as `help.search("rm")`
```
:::
...
-   Data frames are the most common way tabular (row x column, like an Excel spreadsheet) datasets are stored in R
